...
// Dummy formatter if dateFormatOnly unavailable
// const dateFormatOnly = (date) => new Date(date).toLocaleDateString();
...
export default function LeaveSection() {
  ...
  const myLeaveData = dummyMyLeaveData;
  const leaveInfo = dummyLeaveInfo;
  ...
  const casualCount = leaveInfo.casualLeave;
  const compCount = leaveInfo.compensatoryoff;
  const paidCount = leaveInfo.paidLeave;
              ...
              <table className={styles.leaveTable}>
                <thead>
                  <tr>
                    ...
                    <th>
                      <span className={styles.iconText}>
                        <FaCalendarDay /> <span>Duration</span>
                      </span>
                    </th>
                    <th>
                      <span className={styles.iconText}>
                        <FaCalendarCheck /> <span>Total days</span>
                      </span>
                    </th>
                    <th>
                      <span className={styles.iconText}>
                        <PiAirplaneTakeoffFill /> <span>Leave Type</span>
                      </span>
                    </th>
                    <th>
                      <span className={styles.iconText}>
                    ...
                    <th>
                      <span className={styles.iconText}>
                        <FaFileUpload /> <span>Attachment</span>
                      </span>
                    </th>
                    <th>
                      <span className={styles.iconText}>
                ...
                <tbody>
                  {myLeaveData
                    .filter((l) => filter === "All" || l.leaveStatus === filter)
                    .map((l, index) => (
                      <tr key={index}>
