      ...
      <div className={styles.projectCircles}>
        ...
        {projects.length > 0 ? (
          projects.slice(0, 4).map((proj, i) => (
            <div
              key={proj._id || i}
              className={`${styles.circleWrapper} ${i === currentIndex ? styles.activeCircle : ""
                }`}
              onClick={() => {
                setCurrentIndex(i);
                setHasUserSelected(true);
          ...
          <div className={styles.projectDetailSection}>
            ...
            <div className={styles.rightSection}>
              ...
              <div className={styles.text1}>
                <Building2 size={25}  className={styles.texticon}/>
                Spacious Apartments
              </div>
              <div className={styles.selectedProjLocation}>
                <MapPin size={22} className={styles.texticon} /> {currentProject.locationName}
              </div>
