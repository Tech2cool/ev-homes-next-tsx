...
const Gallary = () => {
  ...
  const [selectedGalleryProject, setSelectedGalleryProject] =
    useState<OurProject | null>(null);

  useEffect(() => {
    if (projects.length > 0 && !selectedGalleryProject) {
      setSelectedGalleryProject(projects[0]);
    }
  }, [projects, selectedGalleryProject]);
