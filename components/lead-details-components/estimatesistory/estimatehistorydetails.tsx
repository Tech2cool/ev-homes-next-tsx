      ...
      <div className={`${styles.leadHistoryContainer} ${styles.anotherClass}`}>
        <div className={styles.detailsContainer}>
          ...
          <div className={styles.middleSection}>
            ...
            <p><span className={styles.label}>Team Leader:</span> <span className={styles.value}>{estimate.teamLeader?.firstName} {estimate.teamLeader?.lastName}</span></p>
            <p><span className={styles.label}>Address:</span> <span className={styles.value}>{estimate.lead?.address}</span></p>
          </div>
