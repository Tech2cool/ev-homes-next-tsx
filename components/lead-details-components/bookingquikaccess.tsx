...
const BookingQuikAccess = () => {
  ...
  return (
    <div className={styles.quickAccessContainer}>
      ...
      {demardhistory && <DemandHistory openclick={setdemardhistory} />}
      {addfeedback && <BookingFeedback openclick={setaddfeedback} />}
      {upladdoc && <UploadDocument openclick={setupladdoc} />}
    </div>
  );
};
