...
const AddBooking: React.FC<AddBookingProps> = ({ openclick }) => {
    ...
    const generatePDF = () => {
        ...
        parkingList.forEach((p, i) => {
            addField(`Parking ${i + 1}`, `Floor - ${p.prfloor}, Number - ${p.parkingno}`);
        });
        ...
        doc.text("Generated by Booking Management System", 105, 285, { align: "center" });
        ...
        },
        {
            ...
            fields: (
                <>
                    ...
                    <button className={styles.pdfcnt} onClick={generatePDF}>pdf genrate</button>
