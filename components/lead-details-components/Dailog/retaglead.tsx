...
import { IoIosCalendar, IoMdCalendar, IoMdListBox } from "react-icons/io";
import moment from "moment";

interface ReTagLeadProps {
...
const ReTagLead: React.FC<ReTagLeadProps> = ({ openclick }) => {
    ...
    const onSubmit = () => {
        ...
        if (!formData.whichlist) newErrors.whichlist = "Please select List.";
        if (formData.whichlist === "new" && !formData.cpartner) {
            newErrors.cpartner = "Please select Channel Partner.";
        }
    ...
    return ReactDOM.createPortal(
        ...
        <div className={styles.dialogOverlay}>
            <div ref={dialogRef} className={styles.dialogBox}>
                <h3 className={styles.dialogTitle}>Re-tag-Lead</h3>
                ...
                <div className={styles.dailogcnt}>
                    <div className={styles.formControl}>
                        <label>
                            <RequiredLabel icon={<IoMdListBox className={styles.iconcolor} />} text="From which List" />
                        </label>

                        <select
                            value={formData.whichlist}
                            name="whichlist"
                        ...
                        {errors.whichlist && (
                            <p className={styles.errorMsg}>{errors.whichlist}</p>
                        )}
                    </div>

                    {formData.whichlist === "new" && (
                        <div className={styles.formControl}>
                            <label>
