...
const FeedbackTwo: React.FC<FeedbackTwoProps> = ({ openclick }) => {
    ...
    const onSubmit = () => {
        ...
        if (!formData.clientInterest) newErrors.clientInterest = "Please select Client Interest Level";
        ...
        if (formData.leadStage) {
            if (!formData.priorityTag) newErrors.priorityTag = "Please select Priority Tag";
            if (!formData.siteVisit) newErrors.siteVisit = "Please select Site Visit status";
            if (!formData.reminderDateTime)
                newErrors.reminderDateTime = "Please select Reminder Date & Time";
            if (!formData.reminderType) newErrors.reminderType = "Please select Reminder Type";
            ...
            <div ref={dialogRef} className={styles.dialogBox}>
                ...
                <div className={styles.dailogcnt}>
                    <div className={styles.card}>
                        ...
                        <div className={styles.formControl}>
                            <label>
                                <RequiredLabel icon={<FaStar className={styles.iconcolor} />} text="Client Interest Level" />
                            </label>
                            <select
                            ...
                            {errors.clientInterest && <p className={styles.errorMsg}>{errors.clientInterest}</p>}
                        </div>
                    </div>
                    ...
                    <div className={styles.formControl}>
                        <label>
                            <RequiredLabel icon={<GiProgression className={styles.iconcolor} />} text="Lead Stage" />
                        </label>
                        <select
                        ...
                        {errors.leadStage && <p className={styles.errorMsg}>{errors.leadStage}</p>}
                    </div>
                    ...
                    {formData.leadStage && (
                        <>
                            <div className={styles.card}>
                                <div className={styles.formControl}>
                                    <label>
                                        <RequiredLabel icon={<FaTag className={styles.iconcolor} />} text="Priority Tag" />
                                    </label>
                                    <select
                                    ...
                                    {errors.priorityTag && <p className={styles.errorMsg}>{errors.priorityTag}</p>}
                                </div>

                                <div className={styles.formControl}>
                                    <label>
                                        <RequiredLabel icon={<BsFillPatchQuestionFill className={styles.iconcolor} />} text="Interested in Site Visit" />
                                    </label>
                                    <select
                                    ...
                                    {errors.siteVisit && <p className={styles.errorMsg}>{errors.siteVisit}</p>}
                                </div>
                            </div>
                            {formData.siteVisit === "yes" && (
                                <div className={styles.formControl}>
                                    <label>
                                        <RequiredLabel icon={<FaCalendarAlt className={styles.iconcolor} />} text="Preferred Visit Date" />
                                    </label>
                                    <input
                                        type="date"
                                        ...
                                        onChange={onChangeField}
                                    />
                                    {errors.preferredVisitDate && <p className={styles.errorMsg}>{errors.preferredVisitDate}</p>}
                                </div>
                            )}
                            ...
                            <div className={styles.card}>
                                <div className={styles.formControl}>
                                    <label>
                                        <RequiredLabel icon={<FaClock className={styles.iconcolor} />} text="Reminder Date & Time" />
                                    </label>
                                    <input
                                        type="datetime-local"
                                ...
                                <div className={styles.formControl}>
                                    <label>
                                        <RequiredLabel icon={<LuAlarmClock className={styles.iconcolor} />} text="Reminder Type" />
                                    </label>
                                    <select
                                    ...
                                    {errors.reminderType && <p className={styles.errorMsg}>{errors.reminderType}</p>}
                                </div>
                            </div>
